...
// bcor_read_corr
arma::mat bcor_read_corr(SEXP bcor_ptr,
                         Rcpp::Nullable<Rcpp::IntegerVector> snps);
RcppExport SEXP _rbcor_bcor_read_corr(SEXP bcor_ptrSEXP, SEXP snpsSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  Rcpp::traits::input_parameter<SEXP>::type bcor_ptr(bcor_ptrSEXP);
  Rcpp::traits::input_parameter<Rcpp::Nullable<Rcpp::IntegerVector> >::type
      snps(snpsSEXP);
...
RcppExport SEXP _rbcor_bcor_read_corr2(SEXP bcor_ptrSEXP, SEXP snps1SEXP,
                                       SEXP snps2SEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
...
arma::sp_mat bcor_read_corr_sparse(SEXP bcor_ptr,
                                   Rcpp::Nullable<Rcpp::IntegerVector> snps,
                                   double threshold);
RcppExport SEXP _rbcor_bcor_read_corr_sparse(SEXP bcor_ptrSEXP, SEXP snpsSEXP,
                                             SEXP thresholdSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen =
      Rcpp::wrap(bcor_read_corr_sparse(bcor_ptr, snps, threshold));
  return rcpp_result_gen;
  END_RCPP
}
...
arma::sp_mat bcor_read_corr_sparse2(SEXP bcor_ptr, Rcpp::IntegerVector snps1,
                                    Rcpp::IntegerVector snps2,
                                    double threshold);
RcppExport SEXP _rbcor_bcor_read_corr_sparse2(SEXP bcor_ptrSEXP, SEXP snps1SEXP,
                                              SEXP snps2SEXP,
                                              SEXP thresholdSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  ...
  Rcpp::traits::input_parameter<double>::type threshold(thresholdSEXP);
  rcpp_result_gen =
      Rcpp::wrap(bcor_read_corr_sparse2(bcor_ptr, snps1, snps2, threshold));
  return rcpp_result_gen;
  END_RCPP
}
// bcor_read_corr_packed
Rcpp::S4 bcor_read_corr_packed(SEXP bcor_ptr,
                               Rcpp::Nullable<Rcpp::IntegerVector> snps);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rbcor_bcor_read_corr_sparse2", (DL_FUNC)&_rbcor_bcor_read_corr_sparse2,
     4},
